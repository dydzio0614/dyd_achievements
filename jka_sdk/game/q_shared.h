...
//void AngleVectors( const vec3_t angles, vec3_t forward, vec3_t right, vec3_t up); LMDPLUS
...
//void Info_SetValueForKey( char *s, const char *key, const char *value ); LMDPLUS
...
typedef struct playerState_s {
	...
	vec3_t		moveDir; //NOT sent over the net - nor should it be. //44 48 52
	...
	int			stats[MAX_STATS]; // 236 240 244 248
	...
	qboolean	hasDetPackPlanted; //better than taking up an eFlag isn't it? //684
